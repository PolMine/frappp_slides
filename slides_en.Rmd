...
* **Plenary protocols are a crucial language resource of parliamentary democracy:**<br/>Governance and hollowing out - parliaments still matter.
...
* **"Framework for Parsing Plenary Protocols" (R package _frappp_) ensures total replicability:**<br/>Replication as a precondition for quality management and improving the data from version to version.
...
* consensus on TEI (cp. ParlaCLARIN Workshops, "Reichstagsprotokolle" of BBAW) - but not common in political science

* TEI-XML is useful for standardization, a data exchange format, to ensure interoperability (cp. FAIR principles) - it is not necessarily useful (= slow) for analysis
